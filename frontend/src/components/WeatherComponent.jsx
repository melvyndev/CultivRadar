...
const WeatherComponent = () => {
    ...
    const handleButtonClick = (newWeather) => {
    ...
    return (
        ...
        <div className="container">  
          ...
          <nav>
            <ul>
              <li><button id="button-snow" className={weather === 'snow' ? 'active' : ''} onClick={() => handleButtonClick('snow')}><i className="wi wi-snow"></i></button></li>
              <li><button id="button-wind" className={weather === 'wind' ? 'active' : ''} onClick={() => handleButtonClick('wind')}><i className="wi wi-strong-wind"></i></button></li>
              <li><button id="button-rain" className={weather === 'rain' ? 'active' : ''} onClick={() => handleButtonClick('rain')}><i className="wi wi-rain"></i></button></li>
              <li><button id="button-thunder" className={weather === 'thunder' ? 'active' : ''} onClick={() => handleButtonClick('thunder')}><i className="wi wi-lightning"></i></button></li>
              <li><button id="button-sun" className={weather === 'sun' ? 'active' : ''} onClick={() => handleButtonClick('sun')}><i className="wi wi-day-sunny"></i></button></li>
            </ul>
          </nav>
          <div id="card" className={`weather ${weather}`}>
            <svg id="inner">
              <defs>
