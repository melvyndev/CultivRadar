...
Route::get('api/plants/search/{term}', [PlantController::class, 'search']);

Route::get('api/plants/{latitude}/{longitude}/{averageTemperature}/{averageHumidity}', [PlantController::class, 'getPlantsByLocation']);
